...
void CastleWindow::CreateWallTurret02()
{
    ...
    mFixedHeightRig.Subscribe(mesh->worldTransform, effect->GetPVWMatrixConstant());
...
void CastleWindow::CreateFrontHall()
{
    ...
    for (int i = 0; i < 7; ++i)
    {
        ...
        mFixedHeightRig.Subscribe(meshes[i]->worldTransform, effect->GetPVWMatrixConstant());
...
void CastleWindow::CreateTorch(int i)
{
    ...
    mFixedHeightRig.Subscribe(torchMetal->worldTransform, effect->GetPVWMatrixConstant());
    ...
    mFixedHeightRig.Subscribe(torchWood->worldTransform, effect->GetPVWMatrixConstant());
    ...
    mFixedHeightRig.Subscribe(torchHead->worldTransform, effect->GetPVWMatrixConstant());
...
void CastleWindow::CreateKeg(int i)
{
    ...
    mFixedHeightRig.Subscribe(verMesh->worldTransform, effect->GetPVWMatrixConstant());
    ...
    mFixedHeightRig.Subscribe(horMesh->worldTransform, effect->GetPVWMatrixConstant());
    ...
    mFixedHeightRig.Subscribe(holderMesh->worldTransform, effect->GetPVWMatrixConstant());
    ...
    mFixedHeightRig.Subscribe(barrelMesh->worldTransform, effect->GetPVWMatrixConstant());
...
void CastleWindow::CreateBarrel(int i)
{
    ...
    mFixedHeightRig.Subscribe(barMesh->worldTransform, effect->GetPVWMatrixConstant());
...
void CastleWindow::CreateBunk(int i)
{
    ...
    for (int j = 0; j < 2; ++j)
    {
        ...
        mFixedHeightRig.Subscribe(meshes[j]->worldTransform, effect->GetPVWMatrixConstant());
...
void CastleWindow::CreateChest(int i)
{
    ...
    mFixedHeightRig.Subscribe(topmesh->worldTransform, effect->GetPVWMatrixConstant());
    ...
    mFixedHeightRig.Subscribe(bottommesh->worldTransform, effect->GetPVWMatrixConstant());
...
void CastleWindow::CreateCeilingLight(int i)
{
    ...
    mFixedHeightRig.Subscribe(meshes[0]->worldTransform, effect0->GetPVWMatrixConstant());
    ...
    mFixedHeightRig.Subscribe(meshes[1]->worldTransform, effect1->GetPVWMatrixConstant());
    ...
    mFixedHeightRig.Subscribe(meshes[2]->worldTransform, effect2->GetPVWMatrixConstant());
