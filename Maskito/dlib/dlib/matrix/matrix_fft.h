...
#endif // DLIB_USE_FFTW
#endif // if 0 to exlude fftw
    
#ifdef DLIB_USE_VECLIB_FFT
    
#include "fft_stuff.hpp"
    
    template <long NR, long NC, typename MM, typename L>
    void call_apple_fft_inplace(matrix<std::complex<double>,NR,NC,MM,L>& data)
    {
        // make sure requires clause is not broken
        DLIB_CASSERT(is_power_of_two(data.nr()) && is_power_of_two(data.nc()),
                     "\t matrix fft(data)"
        ...
        int log2_r = impl::fastlog2(data.nr());
        int log2_c = impl::fastlog2(data.nc());
        std::complex<double> * ptr = &data(0,0);
        apple_fft_inplaceD(ptr, log2_r, log2_c);
        
    }
    
    template <long NR, long NC, typename MM, typename L>
    void call_apple_ifft_inplace(matrix<std::complex<double>,NR,NC,MM,L>& data)
    {
        // make sure requires clause is not broken
        DLIB_CASSERT(is_power_of_two(data.nr()) && is_power_of_two(data.nc()),
                     "\t matrix ifft(data)"
        ...
        int log2_c = impl::fastlog2(data.nc());
        std::complex<double> * ptr = &data(0,0);
        apple_ifft_inplaceD(ptr, log2_r, log2_c);
    }
    
    template <long NR, long NC, typename MM, typename L>
    void call_apple_fft_inplace(const matrix<std::complex<float>,NR,NC,MM,L>& data)
    {
        // make sure requires clause is not broken
        DLIB_CASSERT(is_power_of_two(data.nr()) && is_power_of_two(data.nc()),
                     "\t matrix fft(data)"
        ...
        int log2_r = impl::fastlog2(data.nr());
        int log2_c = impl::fastlog2(data.nc());
        std::complex<float> * ptr = &data(0,0);
        apple_fft_inplace(ptr, log2_r, log2_c);
        
    }
    
    template <long NR, long NC, typename MM, typename L>
    void call_apple_ifft_inplace(const matrix<std::complex<float>,NR,NC,MM,L>& data)
    {
        // make sure requires clause is not broken
        DLIB_CASSERT(is_power_of_two(data.nr()) && is_power_of_two(data.nc()),
                     "\t matrix ifft(data)"
        ...
        int log2_c = impl::fastlog2(data.nc());
        std::complex<float> * ptr = &data(0,0);
        apple_ifft_inplace(ptr, log2_r, log2_c);
    }
    
    // ----------------------------------------------------------------------------------------
    
    // call Veclib for these cases:
    
//    inline void fft_inplace (matrix<std::complex<double>,0,1>& data) {data = call_apple_fft_inplace(data);}
//    inline void ifft_inplace(matrix<std::complex<double>,0,1>& data) {data = call_apple_ifft_inplace(data);}
//    inline void fft_inplace (matrix<std::complex<double>,1,0>& data) {data = call_apple_fft_inplace(data);}
//    inline void ifft_inplace(matrix<std::complex<double>,1,0>& data) {data = call_apple_ifft_inplace(data);}
    inline void fft_inplace (matrix<std::complex<double> >& data) {call_apple_fft_inplace(data);}
    inline void ifft_inplace(matrix<std::complex<double> >& data) {call_apple_ifft_inplace(data);}
    
//    inline void fft_inplace (matrix<std::complex<double>,0,1>& data) {data = call_apple_fft_inplace(data);}
//    inline void ifft_inplace(matrix<std::complex<double>,0,1>& data) {data = call_apple_ifft_inplace(data);}
//    inline void fft_inplace (matrix<std::complex<double>,1,0>& data) {data = call_apple_fft_inplace(data);}
//    inline void ifft_inplace(matrix<std::complex<double>,1,0>& data) {data = call_apple_ifft_inplace(data);}
//    inline void fft_inplace (matrix<std::complex<float> >& data) {data = call_apple_fft_inplace(data);}
//    inline void ifft_inplace(matrix<std::complex<float> >& data) {data = call_apple_ifft_inplace(data);}
    
#endif // DLIB_USE_VECLIB_FFT
