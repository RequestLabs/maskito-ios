...
namespace dlib
{
    ...
    public:
        ...
        inline void load(const type* ptr)          { x = _mm_load_si128((const __m128i*)ptr); }
        inline void store(type* ptr)         const { _mm_store_si128((__m128i*)ptr, x); }
