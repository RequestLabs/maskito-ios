...
// Computes the division of the four single-precision, floating-point values of a and b. https://msdn.microsoft.com/en-us/library/vstudio/wh13kadz(v=vs.100).aspx
...
// Compares the 4 signed 32-bit integers in a and the 4 signed 32-bit integers in b for equals. https://msdn.microsoft.com/en-us/library/vstudio/1s9f2z0y(v=vs.100).aspx
