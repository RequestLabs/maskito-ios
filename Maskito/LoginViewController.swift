...
class LoginViewController: UIViewController, TTTAttributedLabelDelegate, UITextFieldDelegate, UITextViewDelegate {
    ...
    let infoStr = "By using this app you agree to our Terms and Conditions and Privacy Policy. If you have forgot your login details, you may need to request a new password. For any questions concerns or ideas please contact humans@requestlabs.com."
    ...
    override func viewDidLoad() {
        ...
        Analytics.view("LoginViewController")
    ...
    func setupTerms() {
        ...
        let tempRange: NSRange = (infoStr as NSString).rangeOfString("request a new password")
        self.terms.addLinkToURL(NSURL(string:"https://requestlabs.appspot.com/app/maskito/forgotpassword?email=" + emailAddress.text!), withRange: tempRange)
        
        let humanRange: NSRange = (infoStr as NSString).rangeOfString("humans@requestlabs.com")
        self.terms.addLinkToURL(NSURL(string:"mailto:humans@requestlabs.com"), withRange: humanRange)
    ...
    func showSubmitAlert() {
        let alertController = UIAlertController(title: "Invalid Login Attempt", message:
    ...
    func textFieldShouldReturn(textField: UITextField) -> Bool {
        ...
        else
        {
            ...
            if !error {
                print("done")
                //
                Auth.login(emailAddress!.text!, password: password!.text!, completionHandler: { (isValid) in
                    if isValid {
